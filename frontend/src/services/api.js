...
export const dashboardService = {
  ...
  getGraficoMensal: async () => {
    const response = await api.get('/dashboard/grafico-mensal');
    return response.data;
  },
  
  getResumoCategorias: async () => {
    const response = await api.get('/dashboard/resumo-categorias');
    return response.data;
  },
  
  getResumoPlataformas: async () => {
    const response = await api.get('/dashboard/resumo-plataformas');
    return response.data;
  }
};
