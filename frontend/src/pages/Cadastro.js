...
import { Eye, EyeOff, Car, Mail, Lock, User, MapPin, Phone } from 'lucide-react';
      ...
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="bg-white py-8 px-6 shadow-lg rounded-lg border border-slate-200">
          <form className="space-y-6" onSubmit={handleSubmit(onSubmit)}>
              ...
              <div className="mt-1 relative">
                ...
                <input
                  {...register('telefone', {
                    ...
                    pattern: {
                      value: /^\+[1-9]\d{1,14}$/,
                      message: 'Telefone deve começar com + seguido do código do país (ex: +5583988828305)'
                    }
                  })}
                  type="tel"
                  className="input pl-10"
                  placeholder="+5583988828305"
                />
              </div>
              {errors.telefone && (
            ...
            <div>
              <label htmlFor="pais_id" className="block text-sm font-medium text-slate-700">
                País
              </label>
              <div className="mt-1 relative">
                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
              ...
              {errors.pais_id && (
                <p className="mt-1 text-sm text-red-600">{getErrorMessage(errors.pais_id)}</p>
              )}
            </div>
