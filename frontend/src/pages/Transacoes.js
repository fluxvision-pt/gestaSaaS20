...
import { Plus, Search, Filter, Edit2, Trash2, Calendar, DollarSign, MapPin, Car } from 'lucide-react';
import { transacaoService, configService } from '../services/api';
  ...
  const carregarDados = async () => {
    try {
      ...
      const [transacoesData, categoriasData, plataformasData, meiosPagamentoData] = await Promise.all([
        ...
        configService.listarCategorias(),
        configService.listarPlataformas(),
        configService.listarMeiosPagamento()
      ]);
